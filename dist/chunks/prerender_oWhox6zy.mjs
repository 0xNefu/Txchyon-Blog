import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, i as renderComponent, j as renderSlot, k as renderTransition } from './astro_X-xMHih5.mjs';
import 'kleur/colors';
import 'clsx';
import { g as getCollection, a as getEntryBySlug } from './pages/rss_ZIF3SzLX.mjs';
import { g as getMonthName, d as $$Default, f as getSlugFromPathname, P as PAGE_SIZE, S as SITE, c as create_ssr_component, h as add_styles, m as merge_ssr_styles, j as add_attribute } from './pages/about_xkxDVZnb.mjs';
/* empty css                         */
/* empty css                          */
/* empty css                         */
import { $ as $$Post } from './pages/item1_EbRybj6v.mjs';
/* empty css                         */
/* empty css                         */
/* empty css                          */
/* empty css                          */

const $$Astro$h = createAstro("https://astro-ink.vercel.app");
...
const $$Astro$g = createAstro("https://astro-ink.vercel.app");
...
const $$Astro$f = createAstro("https://astro-ink.vercel.app");
const $$AsterPrice = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$f, $$props, $$slots);
  Astro2.self = $$AsterPrice;
  return renderTemplate`${maybeRenderHead()}<div class="rounded-2xl bg-gray-900/90 px-10 py-5 backdrop-blur border border-[#00F2FF]/30 shadow-2xl shadow-[#00F2FF]/20"> <span class="text-5xl md:text-6xl font-mono font-bold text-[#00F2FF] tracking-tight">
$ASTER ≈ <span id="price">Loading...</span> <span id="change" class="text-sm ml-2 opacity-80"></span> </span> </div> `;
}, "C:/Users/NefuTrades/txchyon-capital-blog/src/components/asterPrice.astro", void 0);

const $$Astro$e = createAstro("https://astro-ink.vercel.app");
...
</p> <!-- LIVE PRICE --> ${renderComponent($$result2, "AsterPrice", $$AsterPrice, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/NefuTrades/txchyon-capital-blog/src/components/AsterPrice.astro", "client:component-export": "default" })} <p class="mt-20 text-lg text-gray-500">
...
const $$Astro$d = createAstro("https://astro-ink.vercel.app");
